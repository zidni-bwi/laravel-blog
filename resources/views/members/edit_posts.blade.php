...
<div class="col-md-8 bg-white px-4 pt-5 vh-100">
  <form method="post" action="/edit_posts_process">
    @csrf
    <input type="hidden" value="{{ $posts->id }}" name="id">
    <div class="form-group">
      <label>Judul Artikel</label>
      <input type="text" class="form-control" value="{{ $posts->title }}" name="title" placeholder="Judul artikel">
    </div>
    <div class="form-group">
      <label>Isi Artikel</label>
      <textarea id="summernote" class="form-control" name="content">{{ $posts->content }}</textarea>
      <script>
  ...
  <div class="col-md-4 bg-light border-left px-4 pt-5">
  ...
  <label class="font-weight-bold">Thumbail</label>
    ...
    <div class="image_area">
      <label for="upload_image">
        ...
        @else
        <img src="{{ $posts->thumbnail }}" id="preview" class="img-responsive card-img-top img-responsive center-block d-block mx-auto" />
        @endif
        <div class="overlay">
      ...
      <input type="hidden" id="base64" rows="5" name="thumbnail" value="{{ $posts->thumbnail }}">
